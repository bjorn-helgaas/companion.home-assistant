...
Even if you don't need split brain DNS, you may also want to set this up as it will enable you to access Home Assistant via its public name even when your internet connection is down and hairpin NAT won't work. One less dependency on the Cloud!
